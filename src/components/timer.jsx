...
function Timer() {
  ...
  const startTimer = () => {
    ...
    assignInterval(setInterval(incrementNumber, 1000));
  };
  ...
  return (
    <div className="flex items-center flex-col mt-[130px]  gap-[40px]">
      <h2
        className="text-black text-center p-5 text-[100px] font-['Jetbrains_Mono']"
        ref={currentTime}
      >
        {time};
      </h2>
